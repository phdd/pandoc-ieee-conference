...
\ifCLASSINFOpdf
  ...
  % Text width for graphics
  \let\latexincludegraphics\includegraphics%
  \renewcommand{\includegraphics}[2][]{%
    \latexincludegraphics[width=0.48\textwidth,#1]{#2}}%
\else
...
\hyphenation{$for(hyphenation)$$hyphenation$ $endfor$}
